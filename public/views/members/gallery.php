                ...
                <div class="card"
                    ...
                    <a href="/views/members/formcardgalleryEdit.php?id=<?= $card['id'] ?>">
                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                            ...
                            <path fill="#2e2e2e"
                                  d="M19.707 4.293a1 1 0 0 0-1.414 0L14 8.586 5.414 17.172a1 1 0 0 0-.293.707v2.121a1 1 0 0 0 1 1H8a1 1 0 0 0 .707-.293L16 13.414l4.293-4.293a1 1 0 0 0 0-1.414l-2-2zM14 11.414L12.586 10 15 7.586 16.414 9l-2 2zm-5.293 5L12 9.414 14.586 12 10 16.586 6.707 13z"/>
                        </svg>
                    ...
                    <form action="/controllers/GalleryController.php?action=deleteCard" method="POST">
                        ...
                        <button type="submit" style="background: none; border: none; padding: 0; cursor: pointer; position: absolute; top: 10px; right: 40px;">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
                                <path d="M0 0h24v24H0z" fill="none"/>
                                <path fill="#2e2e2e"
                                      d="M19 6h-4V4c0-1.1-.9-2-2-2H9c-1.1 0-2 .9-2 2v2H3c-.55 0-1 .45-1 1v2c0 .55.45 1 1 1h1v10c0 1.1.9 2 2 2h10c1.1 0 2-.9 2-2V10h1c.55 0 1-.45 1-1V7c0-.55-.45-1-1-1zM9 4h6v2H9V4zm7 16H8V10h8v10zm-5-3c0 .55-.45 1-1 1s-1-.45-1-1V13c0-.55.45-1 1-1s1 .45 1 1v4zm-4 0c0 .55-.45 1-1 1s-1-.45-1-1V13c0-.55.45-1 1-1s1 .45 1 1v4zm8 0c0 .55-.45 1-1 1s-1-.45-1-1V13c0-.55.45-1 1-1s1 .45 1 1v4z"/>
                            </svg>
                        </button>
                    </form>
